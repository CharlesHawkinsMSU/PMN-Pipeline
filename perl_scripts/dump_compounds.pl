...
my $out = "Compound_id\tCompound_common_name\tCompound_synonyms\tMolecular_weight\tChemical_formula\tSmiles\tLinks\tEC\tReaction_equation\tPathway\n";
