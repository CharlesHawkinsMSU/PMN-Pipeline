...
my $fa = shift; ### this is the fasta file from MIPS.
...
while (my $line = <FILE>) {
	...
	my $names = join "; ", keys %names; ### here we remove redundant names
	print ">$parts[0] | MIPS: " . $gene_accession . " | " . $names . " | Species: " . $parts[3] . " | Gene: " . $parts[5] . "\n";
	#print ">$gene_accession | PapayaCyc: " . $parts[0] . " | " . $protein_common_name . " | Species: " . $parts[3] . " | Gene: " . $parts[5] . "\n";
