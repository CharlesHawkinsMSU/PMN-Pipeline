...
def main():
    ...
    par.add_argument('-gpn', '--gff-protein-name', default = 'ID', help = 'For GFF input, name field to use as protein_id', dest = 'p')
    ...
    par.add_argument('-gg', '--gff-gene-path', default = 'Parent.ID', help = 'For GFF input, specification for how to find a gene from a protein. Dot separated list of attributes, with the last taken as the name', dest = 'g')
